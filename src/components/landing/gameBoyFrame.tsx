  ...
  return (
    <div className="relative flex flex-col items-center mx-auto scale-90 md:scale-100 pt-4">
      ...
      <div className="absolute top-0 left-12 w-16 h-5 bg-secondary-lightest border-2 border-slate-200 rounded-t-lg flex items-center px-1 cursor-pointer" onClick={onPowerToggle}>
        <div className={`w-6 h-3.5 rounded-sm transition-all duration-300 shadow-sm ${isPowerOn ? 'bg-[#3b82f6] translate-x-7' : 'bg-slate-300 translate-x-0'}`}></div>
      </div>
      ...
      <div className="w-[340px] md:w-[410px] bg-white p-7 rounded-[40px] rounded-br-[120px] border border-slate-200 shadow-2xl relative overflow-hidden">
        ...
        <div className="absolute top-24 left-6 flex flex-col items-center">
          <div className={`w-2 h-2 rounded-full mb-1 transition-colors duration-300 ${isPowerOn ? 'bg-[#3b82f6] shadow-[0_0_8px_#3b82f6]' : 'bg-slate-200'}`}></div>
        ...
        <div className="bg-[#334155] p-6 rounded-2xl border-2 border-slate-400/20 mb-10 relative">
          ...
          <div className="mt-3 flex justify-between items-center text-slate-400 text-[8px] px-2">
        ...
        <div className="flex flex-col gap-10">
          ...
          <div className="flex justify-between items-center px-4">
            ...
            <div className="relative w-28 h-28">
              <div className="absolute left-1/2 -translate-x-1/2 top-0 w-9 h-28 bg-[#cbd5e1] rounded-lg border-b-4 border-slate-300"></div>
              <div className="absolute top-1/2 -translate-y-1/2 left-0 w-28 h-9 bg-[#cbd5e1] rounded-lg border-b-4 border-slate-300"></div>
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-9 h-9 bg-[#cbd5e1]"></div>
