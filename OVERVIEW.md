...
| 이름 | BAEK JU HEE |
| 직함 | Front Developer |
| 연락처 | Phone / Email / GitHub / Portfolio (값은 환경별 관리) |
| 취미 | 풋살 (Futsal) |
| 학력 | 한양여자대학교 졸업 (2014.02) |
| 자격증 | 정보처리기사 (2017.02), 컴퓨터활용능력 1급 (2016.07) |
...
- **필터 영역** (프린트 모드 시 숨김)
  ...
  - 기술 스택 필터 (토글 칩 형태)
  - 정렬 선택 (최신순 / 오래된순)
- **스킬 스택 카드** (PointStackCard): 보유 스택 시각화
- **경력 섹션** (CareerSection): 회사별 프로젝트 나열
- **사이드 프로젝트 섹션** (SideProjectSection): 토이 프로젝트 나열

**데이터 소스:**  
Notion API 연동 + 로컬 JSON 파일 fallback (`src/data/`)
...
| 카드 | 내용 |
|------|------|
| PROJECTS | React 3개 / Vue 5개 / PHP 2개 |
| COMPANYS | Fitogether 4년 / YU파트너스 1년 / 프리랜서 1년 / 틴들로 1년 |
| MAIN TECH USAGE | D3 파이차트 (Vue 50% / React 30% / PHP 20%) |
| CAREER TIMELINE | D3 타임라인 차트 |

**경력 데이터:**

| 회사 | 기간 |
|------|------|
| YU파트너스 (웹 개발자) | 2017.03 ~ 2018.02 (약 11개월) |
| 핏투게더 (프런트 개발자) | 2018.07 ~ 2022.11 (약 4년 4개월) |
